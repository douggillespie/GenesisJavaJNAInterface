...
//		jnaPath +=";C:\\Program Files\\Tritech\\Gemini SDK\\bin\\x64";
	...
	public interface GlfLib extends Library {
		...
		public int svs5SetConfiguration(int configType, int size, ByteByReference configData, int deviceId);
		
		public int svs5GetConfiguration(int configType, long size, ByteByReference configData, int deviceId);
